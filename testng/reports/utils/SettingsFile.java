...
public class SettingsFile {
	...
	public static void create(String paramString) throws ATUReporterException {
		...
		try {
			...
			throw new ATUReporterException(
					"Unable To Create Required Files for Custom Reports");
		}
	}
	...
	public static void correctErrors() throws NumberFormatException,
			ATUReporterException {
	...
	private static boolean isFirstParamBig(int paramInt1, int paramInt2,
