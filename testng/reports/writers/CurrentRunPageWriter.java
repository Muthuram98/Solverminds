...
public class CurrentRunPageWriter extends ReportsPage {
	public static void menuLink(PrintWriter paramPrintWriter, int paramInt) {
		...
		if (paramInt == 1)
			paramPrintWriter.println("\n <li class=\"menuStyle\"><a href=\""
					+ Directory.RUNName + paramInt + Directory.SEP
					+ "CurrentRun.html\" >" + "Run " + paramInt
					+ " </a></li>\n");
		else
			for (int i = 1; i <= paramInt; ++i) {
				...
				paramPrintWriter
						.println("\n <li class=\"menuStyle\"><a href=\""
								+ Directory.RUNName + i + Directory.SEP
								+ "CurrentRun.html\" >" + "Run " + i
								+ " </a></li>\n");
			}
		paramPrintWriter
				.println("\n                    </ul>\n                </td>\n\n");
	...
	public static String getExecutionTime(ITestResult paramITestResult) {
		long l = paramITestResult.getEndMillis()
				- paramITestResult.getStartMillis();
		if (l > 1000L) {
			l /= 1000L;
			return l + " Sec";
		}
	...
	public static void content(PrintWriter paramPrintWriter,
			ISuite paramISuite, List<ITestResult> paramList1,
			List<ITestResult> paramList2, List<ITestResult> paramList3,
			List<ITestResult> paramList4, List<ITestResult> paramList5,
			List<ITestResult> paramList6, int paramInt, long paramLong1,
			long paramLong2) {
		...
		paramPrintWriter
				.println("<td id=\"content\">\n                    <div class=\"info\">\n                        The following pie chart demonstrates the percentage of Passed, Failed and Skipped Test Cases<br/>\n                        Time Taken for Executing below Test Cases: <b>"
						...
						+ ATUReports.currentRunDescription
						+ "</div>"
						+ "                    <div>\n"
		...
		if (Directory.recordSuiteExecution)
			...
			paramPrintWriter
					.println("<p id=\"showmenu\">No Video Recording Available</p>");
		paramPrintWriter
	...
	private static void writePassedData(PrintWriter paramPrintWriter,
	...
	private static void writeFailedData(PrintWriter paramPrintWriter,
			List<ITestResult> paramList, int paramInt) {
		String str = "fail";
		Iterator localIterator = paramList.iterator();
		while (localIterator.hasNext()) {
	...
	private static void writeSkippedData(PrintWriter paramPrintWriter,
			List<ITestResult> paramList, int paramInt) {
		String str = "skip";
		Iterator localIterator = paramList.iterator();
		while (localIterator.hasNext()) {
	...
	public static String getTestCaseHTMLPath(ITestResult paramITestResult,
		...
		String str2 = str1.substring(str1.indexOf(Directory.RUNName + paramInt)
				+ i + 1);
		return str2 + Directory.SEP + getTestCaseName(paramITestResult)
				+ ".html";
	}

	public static String getPackageName(ITestResult paramITestResult) {
		return paramITestResult.getTestClass().getRealClass().getPackage()
				.getName();
	}
	...
	public static String getReportDir(ITestResult paramITestResult) {
		...
		str4 = str4 + "_Iteration"
				+ paramITestResult.getMethod().getCurrentInvocationCount();
		String str5 = str1 + Directory.SEP + str2 + Directory.SEP + str3
				+ Directory.SEP + str4;
		return str5;
	}
